 ...
 include_once 'config.php';
  ...
  if(!$_GET['location_id'])
  {
	header("location:manageprocess.php");  
  }
	  ...
	  if(isset($_GET['location_id']))
				 ...
				 $sel_user="SELECT * from process where location_id=' ". $_GET['location_id']. " '";
  ...
  <?php
   if(isset($_POST['btn-default']))
	...
	$sql = "UPDATE process SET description='$desc',name='$name' WHERE location_id=' ". $_GET['location_id']. " '";
...
?>
   ...
   <?php
    ...
    ?>
            ...
            <div class="col-sm-2"><label>Company Id:</label></div>
            <div class="col-sm-4">
            <input class="span4" type="text" id="company_name" name="company_name" value="<?php echo  $data['company_id']; ?>"  readonly / >
               ...
               <div class="row form-row">
            <div class="col-sm-2"><label>Location Id:</label></div>
            <div class="col-sm-4">
            <input class="span4" type="text" id="location_name" name="location_name" value="<?php echo  $data['location_id']; ?>"  readonly / >
            </div>
            </div>
